...
# Al escribir la primera li­nea con un nivel de sangrado inferior, se cierra el condicional
...
# `ii += 1` equivale a `ii = ii + 1`. En el segundo, Python realiza la operacion 'ii + 1' creando un nuevo objeto con ese valor y luego lo asigna a la variable 'ii'. Existe una reasignaciÃ³n. En el primero, sin embargo, el incremento se produce sobre la propia variable. Esto puede conducirnos a mejoras en velocidad
